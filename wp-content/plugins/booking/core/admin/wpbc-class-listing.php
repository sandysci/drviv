            ...
            ?><div class="wpbc-listing-collumn col-sm-<?php echo $is_free ? '2' : '3'; ?> col-xs-12">
                <div class="row"><?php 
                  ...
                  ?><div class="wpbc-no-margin col-sm-<?php echo $is_free ? '6' : '7'; ?> col-xs-10 text-left field-labels booking-labels wpbc_column_3" >
                        ...
                        <span class="label label-default label-approved <?php if (! $row_data['is_approved']) echo ' hidden_items '; ?>"><?php _e('Completed' ,'booking'); ?></span>
