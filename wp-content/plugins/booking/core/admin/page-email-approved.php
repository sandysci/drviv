...
*/
        ...
        $this->fields['subject'] = array(   
                                      'type'        => 'text'
                                    , 'default'     => __( 'Your booking has been completed', 'booking' )
                                    //, 'placeholder' => ''
        ...
        if ( class_exists( 'wpdev_bk_personal' ) )        
            $email_content = sprintf( __( 'Your reservation %s for: %s has been completed.%sYou can edit the booking on this page: %s Thank you, %s', 'booking' ), '[bookingtype]', '[dates]', '<br/><br/>[content]<br/><br/>', '[visitorbookingediturl]<br/><br/>', $blg_title . '<br/>[siteurl]' );
        else
            $email_content = sprintf( __( 'Your booking %s for: %s has been completed.%sThank you, %s', 'booking' ), '[bookingtype]', '[dates]', '<br/><br/>[content]<br/><br/>', $blg_title . '<br/>[siteurl]' );
...
//                    );
        ...
        $subtabs['approved'] = array( 
                            ...
                            , 'title' =>  $icon . __('Completed' ,'booking') . $sufix        // Title of TAB    
                            , 'page_title' => __('Emails Settings', 'booking')  // Title of Page   
            ...
            <form  name="<?php echo $submit_form_name; ?>" id="<?php echo $submit_form_name; ?>" action="" method="post" autocomplete="off">
                ...
                <div class="metabox-holder">
                    ...
                    <?php 
                        ...
                        wpbc_open_meta_box_section( $submit_form_name . 'general', __('Send an Email to Visitor after completing a booking.', 'booking')   );
