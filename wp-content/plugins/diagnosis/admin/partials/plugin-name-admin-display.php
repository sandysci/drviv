...
<form method="post" name="cleanup_options" action="options.php">
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        var_dump(get_option($this->plugin_name));
        // Cleanup
        ...
        <fieldset>
            ...
            <label for="<?php echo $this->plugin_name; ?>-jquery_cdn">
                ...
                <span><?php esc_attr_e('Load jQuery from CDN', $this->plugin_name); ?></span>
                    ...
                    <fieldset>
                        <p>You can choose your own cdn provider and jQuery version
                            (default will be Google Cdn and version 1.11.1)-Recommended CDN are 
                            <a href="https://cdnjs.com/libraries/jquery">CDNjs</a>,
                             <a href="https://code.jquery.com/jquery/">jQuery official CDN</a>, 
                             <a href="https://developers.google.com/speed/libraries/#jquery">Google CDN</a> 
                             and <a href="http://www.asp.net/ajax/cdn#jQuery_Releases_on_the_CDN_0">Microsoft CDN</a></p>
                        <legend class="screen-reader-text"><span><?php _e('Choose your prefered cdn provider',
                         $this->plugin_name); ?></span></legend>
                        <input type="url"
                         class="regular-text" id="<?php echo $this->plugin_name; ?>-cdn_provider" 
                         name="<?php echo $this->plugin_name; ?>[cdn_provider]" placeholder="url" value=""/>
                    </fieldset>

                    <fieldset>
                       
                        <legend class="screen-reader-text"><span><?php _e('Enter firstname',
                         $this->plugin_name); ?></span></legend>
                        <input type="text"
                         class="regular-text" id="<?php echo $this->plugin_name; ?>-firstname" placeholder="Ezeibe" 
                         name="<?php echo $this->plugin_name; ?>[firstname]" value=""/>
                    </fieldset>
